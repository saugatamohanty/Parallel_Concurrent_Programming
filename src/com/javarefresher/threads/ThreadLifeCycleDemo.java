...
class ChefOliviaRunnable implements Runnable{
    public void run() {
        System.out.println("OliviaRunnable started & waiting for sausage to thaw...");
        try {
            Thread.sleep(3000);
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
        System.out.println("OliviaRunnable is done cutting sausage.");
    }
}
...
public class ThreadLifeCycleDemo {
    public static void main(String args[]) throws InterruptedException {
        ...
        System.out.println(" Olivia State 1:  " + olivia.getState());
        System.out.println("Barron tells Olivia to start.");
        olivia.start();
        System.out.println(" Olivia State 2:  " + olivia.getState());
        System.out.println("Barron continues cooking soup.");
        Thread.sleep(500);
        System.out.println(" Olivia State 3:  " + olivia.getState());
        System.out.println("Barron patiently waits for Olivia to finish and join...");
        olivia.join();
        System.out.println(" Olivia State 4:  " + olivia.getState());
